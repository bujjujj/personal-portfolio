      ...
      <div className="w-full min-h-screen py-12 pt-32 px-4 md:px-8 lg:py-32">
        <main className="max-w-5xl mx-auto p-8 md:p-16 lg:p-24 rounded-[3rem] bg-black/20 backdrop-blur-md border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.3)] space-y-32 relative z-20">
          ...
          >
            ...
            <div className="flex gap-5 flex-wrap items-center mt-8 w-full">
              <div className="flex items-center gap-3 px-6 py-4 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-white shrink-0">
                ...
                <span className="text-lg font-medium leading-tight whitespace-nowrap">
                  {personalInfo.university}
                  <span className="text-white/60"> · {personalInfo.major}</span>
                </span>
              </div>
              <a href={`mailto:${personalInfo.email}`} className="w-14 h-14 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur-md transition-all cursor-pointer text-white hover:scale-105 active:scale-95 shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
              </a>
              <a href={personalInfo.github} target="_blank" rel="noreferrer" className="w-14 h-14 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur-md transition-all cursor-pointer text-white hover:scale-105 active:scale-95 shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
              </a>
              <a href={personalInfo.linkedin} target="_blank" rel="noreferrer" className="w-14 h-14 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur-md transition-all cursor-pointer text-white hover:scale-105 active:scale-95 shrink-0">
